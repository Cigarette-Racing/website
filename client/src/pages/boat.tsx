...
import InquiryModal, { useInquiryModalState } from '../molecules/inquiry-modal'
        ...
        <div className="md:px-12 lg:px-16 relative max-w-5xl mx-auto">
          ...
          <div className="text-center px-4 max-w-2xl mx-auto lg:mb-8">
            ...
            <Typography variant="p2">
              ...
              consectetur adipiscing elit, sed do consectetur adipiscing elit,
              sed do{' '}
            </Typography>
          </div>
        </div>
